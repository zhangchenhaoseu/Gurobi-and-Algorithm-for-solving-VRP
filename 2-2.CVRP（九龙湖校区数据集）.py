...
def readData(path, customerNum, vehicleNum, capacity):
    ...
    SP_data = pd.read_csv(r'C:\Users\张晨皓\Desktop\张晨皓的汇报内容\50.几种常见的VRP及Gurobi实现\程序代码\data\JiulonghuSP.txt')
...
if __name__ =="__main__":
    # 数据集路径
    data_path = r'C:\Users\张晨皓\Desktop\张晨皓的汇报内容\50.几种常见的VRP及Gurobi实现\程序代码\data\Jiulonghu.txt'  # 这里是节点文件
    customerNum = 25
    vehicleNum = 5
    capacity = 100
    # 读取数据
